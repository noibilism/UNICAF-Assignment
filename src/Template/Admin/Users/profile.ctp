            ...
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    if (Setting::read('Member.AnyoneCanDeactive')) {
                        ...
                        echo $this->Form->postLink(__('Deactivate account'), ['action' => 'deactive'], ['confirm' =>
                    __('Are you sure you want to deactive your account?'), 'style' => 'background: #DC2A26; color: #fff']);
                        echo '</li>';
                    }
                    ?>
                </ul>
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active card-body">
                        <?php
                            ...
                            echo $this->Form->input('phone', ['autofocus' => true]);
                            echo $this->Form->input('birthday', ['autofocus' => true, 'minYear' => date('Y') - 70,
                        'maxYear' => date('Y') - 1]);
